...
```bash
dx bash -c "bash /root/ofsrc/aim/.claude/skills/code-reviewer-base/scripts/measure_diff_cov.sh [BASE_BRANCH]"
```
...
- 변경 파일 목록:
  - `<path>` (+X lines)
- 측정 스크립트: `.claude/skills/code-reviewer-base/scripts/measure_diff_cov.sh`
