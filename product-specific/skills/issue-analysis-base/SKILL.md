...
|---------|----------|--------|
| **Bug** | Code doesn't match spec or intended behavior | → brainstorming-base (pass analysis_report.md) |
...
analysis_report.md exists
  └─→ brainstorming-base (skip re-collection, use analysis_report.md)
        └─→ writing-plans-base → executing-plans-base → ...
```

**Key:** brainstorming-base checks for `analysis_report.md`. If present, it skips the information gathering phase and uses the analysis directly.
...
- IMS 응답/가이드 초안 작성 시: **writing-documents-base**의 ims-guide.md 참조
- Jira feature request 초안 작성 시: **writing-documents-base**의 jira-guide.md 참조
- analysis_report.md 구조: **writing-documents-base**의 markdown-guide.md "분석 보고서" 참조
...
- Jumping to brainstorming-base without analysis_report.md
...
**Feeds into (verdict별):**
- **brainstorming-base** — Bug/기능 필요 시 (analysis_report.md 전달, 재수집 skip)
- **writing-documents-base** — IMS 답변/Jira feature request 초안 작성 시
