...
description: Use when gathering issue, PR, diff, and design context before running a structured ofgw code review
---
...
This skill is the `ofgw`-safe productized counterpart of the AIM info-collector pattern. It keeps the reusable context-gathering role, but removes AIM-only project IDs, fixed topic naming, and legacy output assumptions.

## When to Use

- Before a full review of an `ofgw` change
