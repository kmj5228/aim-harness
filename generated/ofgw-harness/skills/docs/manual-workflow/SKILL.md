...
description: Use when ofgw work may require manual follow-up and a draft must be prepared under the generated manual workspace
---

# Manual Workflow

Run the `ofgw` manual follow-up flow as a local drafting workflow.
