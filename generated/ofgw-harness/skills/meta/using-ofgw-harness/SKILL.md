---
name: using-ofgw-harness
description: Use at session start inside the generated ofgw-harness runtime to enforce skill-first routing, startup contract reloading, and explicit skill-gap reporting before ad hoc work
---
...
<EXTREMELY-IMPORTANT>
If there is even a small chance a generated OFGW harness skill applies, read that skill before acting.
...
3. Generated OFGW harness skills
...
- `[Skill Gap] writing-documents: current generated docs flow does not cover this output channel`

## Runtime Boundaries

- This meta skill belongs to the generated OFGW runtime only.
