...
description: Use when osd work may require manual follow-up and a draft must be prepared under the generated manual workspace
---

# Manual Workflow

Run the `osd` manual follow-up flow as a local drafting workflow.
