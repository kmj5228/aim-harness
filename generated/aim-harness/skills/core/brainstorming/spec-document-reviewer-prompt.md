...
Agent tool (general-purpose):
  ...
  prompt: |
    You are a spec document reviewer for the AIM C project. Verify this spec is complete and ready for planning.
    ...
    **Spec to review:** [SPEC_FILE_PATH]
    ...
    | AIM conventions | Header organization (include/, _inner.h, {SOURCE}.h), errcode/msgcode |
    | Interface changes | External API changes documented in include/{MODULE}.h |
