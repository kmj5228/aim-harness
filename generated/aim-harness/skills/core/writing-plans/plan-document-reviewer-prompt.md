...
Agent tool (general-purpose):
  ...
  prompt: |
    You are a plan document reviewer for the AIM C project. Verify this plan is ready for implementation.
    ...
    **Spec for reference:** [SPEC_FILE_PATH]
    ...
    | AIM conventions | dx commands, header organization, test file naming |
    | TDD cycle | Every task: RED (failing gtest) -> GREEN (minimal code) -> dx make -> commit |
