...
1. **Create Failing Test Case**
   ...
   ```
   **REQUIRED:** Use test-driven-development for the failing test.
...
**Called by:**
- **executing-plans** — 테스트 실패 시
- **subagent-driven-development** — implementer 서브에이전트 내부 실패 시
- **dispatching-parallel-agents** — 독립 문제 조사 시

**Uses:**
- **test-driven-development** Phase 4 — 수정 검증 테스트 작성
