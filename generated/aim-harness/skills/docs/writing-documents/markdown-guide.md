...
| prefix | 스킬 |
|--------|------|
| `analysis_` | issue-analysis |
| `design_` | brainstorming |
| `plan_` | writing-plans |
| `exec_` | executing-plans |
| `debug_` | systematic-debugging |
| `verify_` | verification-before-completion |
| `finish_` | finishing-a-development-branch |
...
> **For agentic workers:** Use executing-plans to implement.
