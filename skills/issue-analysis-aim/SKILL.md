...
|---------|----------|--------|
| **Bug** | Code doesn't match spec or intended behavior | → brainstorming-aim (pass analysis_report.md) |
...
analysis_report.md exists
  └─→ brainstorming-aim (skip re-collection, use analysis_report.md)
        └─→ writing-plans-aim → executing-plans-aim → ...
```

**Key:** brainstorming-aim checks for `analysis_report.md`. If present, it skips the information gathering phase and uses the analysis directly.
