...
AIM 프로젝트 개발 워크플로우를 AI 코딩 에이전트(Claude Code)에게 가르치는 스킬 체계이다.

[superpowers](https://github.com/obra/superpowers)의 14개 스킬 구조를 fork하여 AIM 환경(C/GoogleTest/Docker/GitLab)에 맞게 커스터마이즈하고, AIM 전용 스킬 4개를 추가하여 총 18개 스킬로 구성된다.
